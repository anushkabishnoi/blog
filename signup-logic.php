...
if (isset($_POST['submit'])) {
    ...
    if (!$firstname) {
        ...
        if ($createpassword !== $confirmpassword) {
            ...
            $user_check_query = "SELECT * FROM users WHERE 'username' OR email='$email'";
            ...
            if (mysqli_num_rows($user_check_result) > 0) {
                ...
                if (in_array($extention, $allowed_files)) {
                    ...
                    $_SESSION['signup'] = "File should be png, jbg, or jpeg";
                }
            }
        }
    }
    ...
    if (isset($_SESSION['signup'])) {
        ...
        if (!mysqli_errno($connection)) {
            ...
            $_SESSION['signup-success'] = "Registration successful. Plese log in";
